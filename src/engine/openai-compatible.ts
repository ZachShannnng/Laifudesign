/**
 * 统一 OpenAI 兼容 SSE 客户端
 * 1 个客户端覆盖所有 provider（Anthropic、OpenAI、智谱、自定义中转站）
 * 所有 provider 均走 OpenAI /v1/chat/completions 兼容格式
 */

import type { StreamChunk } from './ModelClient'
 ...
 * 适用于所有 OpenAI 兼容端点（Anthropic 中转站、OpenAI、智谱、自定义）
 */
